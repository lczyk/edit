...
//!
//! Two groups live here: terminal i/o (raw-mode toggle, sigwinch-driven
//! resize injection, the polling stdin reader, stdout writes) and the
//! filesystem / ICU helpers the editor needs.
